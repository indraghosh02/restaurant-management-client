...
const Footer = () => {
    return (
        <footer className="footer footer-background footer-center p-10  text-primary-content">
  <aside >
    ...
    <img className='h-[100px] w-[100px] footer-content' src="https://i.ibb.co/5MtR1Qh/Dish-Dine-1-1.png" alt="" />
    <p className="font-bold text-white footer-content">
      Dish & Dine <br/>Providing Restaurant Service since 2021
    </p> 
    <p className='text-white footer-content'>Call us on: +880 1543876530</p>
    <p className='text-white footer-content'>Copyright © 2024 - All right reserved</p>
  </aside> 
  <nav>
    <div className="grid grid-flow-col gap-4 footer-content">
