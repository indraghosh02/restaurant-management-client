...
{/* form */}
          ...
          <div className="flex items-center justify-between mt-4">
           ...
           {/* <a type="btn"
            href="#"
            className="flex items-center justify-center mt-4 text-black bg-white  transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
            <div className="px-4 py-2">
              ...
              >
                ...
                />
                <path
                  d="M36.3425 16.7358H35V16.6667H20V23.3333H29.4192C28.7592 25.1975 27.56 26.805 26.0133 27.9758C26.0142 27.975 26.0158 27.9742L31.1742 32.3392C30.8092 32.6708 36.6667 28.3333 36.6667 20C36.6667 18.8825 36.5517 17.7917 36.3425 16.7358Z"
                  fill="#1976D2"
                />
              </svg>
            </div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            >
              New here? plz <Link to='/register' className="text-yellow-400 font-bold ">Sign Up</Link>
            </a>
            <span className="w-1/5 border-b dark:border-gray-600 lg:w-1/4"></span>
          </div>
        </div>
